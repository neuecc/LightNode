...
namespace LightNode.Server
{
    ...
    {
        void OnProcessInterrupt(ILightNodeOptions options, HttpContext httpContext, InterruptReason reason, string detail);
        bool OnStartProcessRequest(ILightNodeOptions options, HttpContext httpContext);
